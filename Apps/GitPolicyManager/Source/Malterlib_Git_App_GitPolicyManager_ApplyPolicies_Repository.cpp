...
{
	TCFuture<void> CGitPolicyManagerActor::fp_ApplyPolicies_RepositorySettings
		(
			CEJSONSorted _Properties
			, CStr _Repository
		...
		)
	{
		...
		co_await PolicyActor(&CGitPolicyActor::f_ApplyPolicy_Repository, fg_Move(Context), fg_Move(_Properties));
